...
void _sourcereaction_function_0(void* instance_args) {
    ...
    #line 11 "/Users/sailor/Developer/EDAN15/Lab1/lab1.lf"
    lf_schedule(a, self-> start);
#line 14 "/Users/sailor/Developer/EDAN15/src-gen/Lab1/lab1/_source.c"
}
...
void _sourcereaction_function_1(void* instance_args) {
    ...
    #line 15 "/Users/sailor/Developer/EDAN15/Lab1/lab1.lf"
    instant_t elapsed_logical_time = lf_time_logical_elapsed();
    self -> interval += self -> incr;
    lf_set(out, 2);
    lf_schedule(a, self->interval);
#line 34 "/Users/sailor/Developer/EDAN15/src-gen/Lab1/lab1/_source.c"
}
#include "include/api/set_undef.h"
