...
#include "include/lab1_5/_lf_GenDelay_b1fe7385.h"
#include "__lf_gendelay_b1fe7385.h"
// ***** Start of method declarations.
// ***** End of method declarations.
#include "include/api/set.h"
void __lf_gendelay_b1fe7385reaction_function_0(void* instance_args) {
    __lf_gendelay_b1fe7385_self_t* self = (__lf_gendelay_b1fe7385_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    lf_critical_section_enter(self->base.environment);
    // Expose the action struct as a local variable whose name matches the action name.
    __lf_gendelay_b1fe7385_act_t* act = &self->_lf_act;
    ...
    __lf_gendelay_b1fe7385_out_t* out = &self->_lf_out;
    lf_set(out, act->value);
#line 24 "/Users/sailor/Developer/EDAN15/src-gen/Lab1/lab1_5/__lf_gendelay_b1fe7385.c"
}
#include "include/api/set_undef.h"
#include "include/api/set.h"
void __lf_gendelay_b1fe7385reaction_function_1(void* instance_args) {
    __lf_gendelay_b1fe7385_self_t* self = (__lf_gendelay_b1fe7385_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    __lf_gendelay_b1fe7385_inp_t* inp = self->_lf_inp;
    int inp_width = self->_lf_inp_width; SUPPRESS_UNUSED_WARNING(inp_width);
    __lf_gendelay_b1fe7385_act_t* act = &self->_lf_act;
    lf_schedule_copy(act, 0, &inp->value, 1);  // Length is 1.
#line 34 "/Users/sailor/Developer/EDAN15/src-gen/Lab1/lab1_5/__lf_gendelay_b1fe7385.c"
}
#include "include/api/set_undef.h"
__lf_gendelay_b1fe7385_self_t* new___lf_gendelay_b1fe7385() {
    __lf_gendelay_b1fe7385_self_t* self = (__lf_gendelay_b1fe7385_self_t*)_lf_new_reactor(sizeof(__lf_gendelay_b1fe7385_self_t));
    ...
    self->_lf__reaction_0.function = __lf_gendelay_b1fe7385reaction_function_0;
    ...
    self->_lf__reaction_1.function = __lf_gendelay_b1fe7385reaction_function_1;
