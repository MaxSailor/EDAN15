...
// file://Users/sailor/Developer/EDAN15/Lab1/lab1_5.lf
#define LOG_LEVEL 2
#define TARGET_FILES_DIRECTORY "/Users/sailor/Developer/EDAN15/src-gen/Lab1/lab1_5"
...
void _lf_initialize_trigger_objects() {
    ...
    __lf_gendelay_3ed783c7_self_t* lab1_5_delay_self[1];
    ...
    {
        _lab1_5_main_main_self_t *self = lab1_5_main_self[0];
        // ***** Start initializing lab1_5.delay of class _lf_GenDelay_3ed783c7
        lab1_5_delay_self[0] = new___lf_gendelay_3ed783c7();
    ...
    // Iterate over ranges lab1_5.Stringln.out_int(0,1)->[lab1_5.delay.inp(0,1)] and lab1_5.delay.inp(0,1).
    {
        ...
        // Iterate over range lab1_5.delay.inp(0,1).
        {
            ...
            int dst_bank = 0; SUPPRESS_UNUSED_WARNING(dst_bank); // Bank index.
            int range_count = 0; SUPPRESS_UNUSED_WARNING(range_count);
            lab1_5_delay_self[dst_runtime]->_lf_inp = (__lf_gendelay_3ed783c7_inp_t*)&lab1_5_stringln_self[src_runtime]->_lf_out_int;
        }
    }
