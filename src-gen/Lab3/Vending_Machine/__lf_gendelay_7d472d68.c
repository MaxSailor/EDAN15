...
#include "include/Vending_Machine/_lf_GenDelay_7d472d68.h"
#include "__lf_gendelay_7d472d68.h"
// ***** Start of method declarations.
// ***** End of method declarations.
#include "include/api/set.h"
void __lf_gendelay_7d472d68reaction_function_0(void* instance_args) {
    __lf_gendelay_7d472d68_self_t* self = (__lf_gendelay_7d472d68_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    lf_critical_section_enter(self->base.environment);
    // Expose the action struct as a local variable whose name matches the action name.
    __lf_gendelay_7d472d68_act_t* act = &self->_lf_act;
    ...
    __lf_gendelay_7d472d68_out_t* out = &self->_lf_out;
    lf_set(out, act->value);
#line 24 "/Users/sailor/Developer/git/EDAN15/src-gen/Lab3/Vending_Machine/__lf_gendelay_7d472d68.c"
}
#include "include/api/set_undef.h"
#include "include/api/set.h"
void __lf_gendelay_7d472d68reaction_function_1(void* instance_args) {
    __lf_gendelay_7d472d68_self_t* self = (__lf_gendelay_7d472d68_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    __lf_gendelay_7d472d68_inp_t* inp = self->_lf_inp;
    int inp_width = self->_lf_inp_width; SUPPRESS_UNUSED_WARNING(inp_width);
    __lf_gendelay_7d472d68_act_t* act = &self->_lf_act;
    lf_schedule_copy(act, 0, &inp->value, 1);  // Length is 1.
#line 34 "/Users/sailor/Developer/git/EDAN15/src-gen/Lab3/Vending_Machine/__lf_gendelay_7d472d68.c"
}
#include "include/api/set_undef.h"
__lf_gendelay_7d472d68_self_t* new___lf_gendelay_7d472d68() {
    __lf_gendelay_7d472d68_self_t* self = (__lf_gendelay_7d472d68_self_t*)_lf_new_reactor(sizeof(__lf_gendelay_7d472d68_self_t));
    ...
    self->_lf__reaction_0.function = __lf_gendelay_7d472d68reaction_function_0;
    ...
    self->_lf__reaction_1.function = __lf_gendelay_7d472d68reaction_function_1;
