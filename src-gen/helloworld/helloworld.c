...
// file://Users/sailor/Developer/EDAN15/helloworld.lf
#define LOG_LEVEL 2
#define TARGET_FILES_DIRECTORY "/Users/sailor/Developer/EDAN15/src-gen/helloworld"
...
void _lf_create_environments() {
    environment_init(&envs[helloworld_main],"helloworld",helloworld_main,_lf_number_of_workers,0,1,0,0,0,0,0,NULL);
}
...
void _lf_initialize_trigger_objects() {
    ...
    envs[helloworld_main].startup_reactions[startup_reaction_count[helloworld_main]++] = &helloworld_main_self[0]->_lf__reaction_0;
